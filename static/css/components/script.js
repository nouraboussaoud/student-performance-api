// Définition des états d'animation du bouton
...
function initLogoutButtons() {
  console.log("Initialisation des boutons de déconnexion...");
  
  document.querySelectorAll('.logoutButton').forEach(button => {
    console.log("Bouton de déconnexion trouvé et initialisé");
    ...
    // Événement de clic avec animation et redirection
...
// Vérifier à nouveau après un certain délai pour s'assurer que les composants dynamiques sont chargés
setTimeout(initLogoutButtons, 1000);